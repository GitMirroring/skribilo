...
(markup-writer 'bold
  ...
  :after "</strong>")
(markup-writer 'underline :before (html-markup-class "u" #f) :after "</u>")
(markup-writer 'strike :before (html-markup-class "strike" #f) :after "</strike>")
(markup-writer 'emph :before (html-markup-class "em" #f) :after "</em>")
(markup-writer 'kbd :before (html-markup-class "kbd" #f) :after "</kbd>")
(markup-writer 'it :before (html-markup-class "em" #f) :after "</em>")
(markup-writer 'tt :before (html-markup-class "tt" #f) :after "</tt>")
(markup-writer 'code :before (html-markup-class "code" #f) :after "</code>")
(markup-writer 'var :before (html-markup-class "var" #f) :after "</var>")
(markup-writer 'samp :before (html-markup-class "samp" #f) :after "</samp>")
(markup-writer 'sc :before "<span class=\"sc\">" :after "</span>")
(markup-writer 'sf :before "<span class=\"sf\">" :after "</span>")
(markup-writer 'sub :before (html-markup-class "sub" #f) :after "</sub>")
(markup-writer 'sup :before (html-markup-class "sup" #f) :after "</sup>")
